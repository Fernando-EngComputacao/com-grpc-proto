...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "pt.ipb.proto.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<pt.ipb.proto.HelloRequest,
      pt.ipb.proto.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = pt.ipb.proto.HelloRequest.class,
      responseType = pt.ipb.proto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<pt.ipb.proto.HelloRequest,
      pt.ipb.proto.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<pt.ipb.proto.HelloRequest, pt.ipb.proto.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<pt.ipb.proto.HelloRequest, pt.ipb.proto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pt.ipb.proto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pt.ipb.proto.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(pt.ipb.proto.HelloRequest request,
        io.grpc.stub.StreamObserver<pt.ipb.proto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
    ...
    /**
     */
    public void hello(pt.ipb.proto.HelloRequest request,
        io.grpc.stub.StreamObserver<pt.ipb.proto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub
    ...
    /**
     */
    public pt.ipb.proto.HelloResponse hello(pt.ipb.proto.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<pt.ipb.proto.HelloResponse> hello(
        pt.ipb.proto.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((pt.ipb.proto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<pt.ipb.proto.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              pt.ipb.proto.HelloRequest,
              pt.ipb.proto.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return pt.ipb.proto.HelloProto.getDescriptor();
    }
